...
// const y = d3.scaleBand().range([0, height]).paddingInner(0.2).paddingOuter(0.3);
...
// const topAxisGroup = g.append("g").attr("class", "x-axis");
...
// 	const yAxisCall = d3.axisLeft(y).tickFormat("").tickSize(3);
// 	yAxisGroup.call(yAxisCall);

// 	const yAxisRight = d3.axisRight(y);
// 	rightAxisGroup.call(yAxisRight);

// 	const xAxisTopCall = d3.axisTop(x).tickSizeOuter(0);
// 	const xAxisBottomCall = d3.axisBottom(x).tickSizeOuter(0);
// 	topAxisGroup.call(xAxisTopCall);
// 	bottomAxisGroup.call(xAxisBottomCall);

// 	const joins = g.selectAll("line").data(data, (d, i) => {
// 		return d;
// 	});
...
// 	//EXIT
// 	teams.exit().transition(t).remove();
